...
setup(
    ...
    data_files=[
        ...
        (
            "share/" + package_name + "/OACP",
            glob("dream_limo/OACP/*.md"),
        ),
        (
            "share/" + package_name + "/OACP/results",
            glob("dream_limo/OACP/results/*.json"),
        ),
    ...
    entry_points={
        "console_scripts": [
            ...
            "dream_free_goal_authorizer = dream_limo.free_goal_authorizer_node:main",
            "dream_nav2_path_provider = dream_limo.nav2_path_provider_node:main",
            "dream_free_planner = dream_limo.free_planner_node:main",
            "dream_oacp_vb_assessor = dream_limo.OACP.assessor_node:main",
            "dream_oacp_calibration = dream_limo.OACP.calibration_cli:main",
            "dream_merger_cue = dream_limo.merger_cue_cli:main",
